class Pipeline2x2Interleaved(object):
    ...
    s_waitcnt vmcnt(5)
    ds_write_b128 v[v_sst_offset_a0], v[v_gld_a0 + 4 : v_gld_a0 + 7], offset: 129 * 8 * 2
...
label_gemm_rrr_loop_begin:
    ...
    ; s_barrier
    ds_read_b128 v[v_sld_b1 + 0 : v_sld_b1 + 3], v[v_sld_offset_b0], offset: 64 * 8 * 2 * 2 * 1
    ds_read_b128 v[v_sld_a1 + 0 : v_sld_a1 + 3], v[v_sld_offset_a0], offset: 64 * 8 * 2 * 2 * 1
    ; global load n + 2
    v_add_u32 v[v_offset_a], v[v_offset_a], s[s_bs_a]
    v_add_u32 v[v_offset_b], v[v_offset_b], s[s_bs_b]
    ...
    s_waitcnt vmcnt(5)
    ds_write_b128 v[v_sst_offset_a1], v[v_gld_a1 + 4 : v_gld_a1 + 7], offset: 129 * 8 * 2
    buffer_load_dwordx4 v[v_gld_a1 + 4 : v_gld_a1 + 7], v[v_offset_a], s[s_ptr_a : s_ptr_a + 3], s[s_offset_a + 0] offen offset:0
    ...
    ds_read_b128 v[v_sld_a0 + 0 : v_sld_a0 + 3], v[v_sld_offset_a0], offset: (128 + 1) * 8 * 2 * 2 * 1
    ds_read_b128 v[v_sld_b0 + 0 : v_sld_b0 + 3], v[v_sld_offset_b0], offset: 128 * 8 * 2 * 2 * 1
    ds_read_b128 v[v_sld_b1 + 0 : v_sld_b1 + 3], v[v_sld_offset_b0], offset: 128 * 8 * 2 * 2 * 1 + 64 * 8 * 2 * 2 * 1
    ds_read_b128 v[v_sld_a1 + 0 : v_sld_a1 + 3], v[v_sld_offset_a0], offset: (128 + 1) * 8 * 2 * 2 * 1 + 64 * 8 * 2 * 2 * 1
    ...
    ds_read_b128 v[v_sld_b1 + 0 : v_sld_b1 + 3], v[v_sld_offset_b1], offset: 64 * 8 * 2 * 2 * 1
    ds_read_b128 v[v_sld_a1 + 0 : v_sld_a1 + 3], v[v_sld_offset_a1], offset: 64 * 8 * 2 * 2 * 1
